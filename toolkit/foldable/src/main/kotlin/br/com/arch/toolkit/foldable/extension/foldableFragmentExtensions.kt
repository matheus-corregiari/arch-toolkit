 ...
 */
fun Fragment.onNewLayoutInfo(func: (WindowLayoutInfo) -> Unit) = activity?.run {
    lifecycleScope.launch(Dispatchers.Main) {
        lifecycle.repeatOnLifecycle(Lifecycle.State.STARTED) {
            WindowInfoTracker.getOrCreate(this@run)
                .windowLayoutInfo(this@run)
                .collect(func)
        }
    }
}
 ...
 */
fun Fragment.observeFoldableStateChanges(
    layout: ViewGroup,
 ...
 * @param orientation The desired orientation - needed whenever calculating the fold's position on screen
 */
fun Fragment.handleFoldableStateChange(
    layout: ViewGroup,
