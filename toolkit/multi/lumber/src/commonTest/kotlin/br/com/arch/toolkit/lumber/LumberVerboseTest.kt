...
class LumberVerboseTest {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    ...
                    tag = "LumberVerboseTest:verbose-with-simple-message",
    ...
    fun `verbose with message and arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-message-and-arguments",
    ...
    fun `verbose with message and null arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-message-and-null-arguments",
    ...
    fun `verbose with message containing format specifiers but no arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-message-containing-format-specifiers-but-no-arguments",
    ...
    fun `verbose with more arguments than format specifiers`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-more-arguments-than-format-specifiers",
                    message = "this is a formatted text with 2 arguments",
                    error = null
                )
            )
    ...
    fun `verbose with very long message exceeding MAX LOG LENGTH`() {
        val tree = TestTree()
        Lumber.plant(tree)
        Lumber.verbose("a".repeat(6000))
        assertEquals(listOf(tree), Lumber.forest())
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-very-long-message-exceeding-MAX-LOG-LENGTH #0",
                    message = "a".repeat(4000),
                    error = null
                ),
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-very-long-message-exceeding-MAX-LOG-LENGTH #1",
    ...
    fun `verbose with message exactly MAX LOG LENGTH`() {
        val tree = TestTree()
        Lumber.plant(tree)
        Lumber.verbose("a".repeat(4000))
        assertEquals(listOf(tree), Lumber.forest())
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-message-exactly-MAX-LOG-LENGTH",
                    message = "a".repeat(4000),
                    error = null
                )
            )
    ...
    fun `verbose with special characters in message`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-special-characters-in-message",
                    message = "a\nb\tc",
                    error = null
                )
            )
    ...
    fun `verbose with special characters in arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-special-characters-in-arguments",
                    message = "a\nb\tca\nb\tc",
                    error = null
                )
            )
    ...
    fun `verbose with explicit tag and long message`() {
        val tree = TestTree()
        Lumber.plant(tree)
        Lumber.tag("MyTag").verbose("a".repeat(6000))
        assertEquals(listOf(tree), Lumber.forest())
        tree.assertAll(
            listOf(
                TestTree.Data(
    ...
    fun `verbose with message and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-message-and-exception",
    ...
    fun `verbose with message arguments and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-message-arguments-and-exception",
                    message = "this is a formatted text with 2 arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `verbose with empty message and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-empty-message-and-exception",
    ...
    fun `verbose with message and null arguments plus exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-message-and-null-arguments-plus-exception",
                    message = "this is a null text with null arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `verbose with format specifiers but no arguments and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-format-specifiers-but-no-arguments-and-exception",
                    message = "this is a %s text with %d arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `verbose with more arguments than specifiers and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-more-arguments-than-specifiers-and-exception",
                    message = "this is a formatted text with 2 arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `verbose when isLoggable is false with exception`() {
        ...
        Lumber.verbose(IllegalStateException("nope"), "normal text without arguments")
    ...
    fun `verbose when quiet is true with exception`() {
        ...
        Lumber.verbose(IllegalStateException("quiet"), "normal text without arguments")
    ...
    fun `verbose with special characters and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-special-characters-and-exception",
                    message = "a\nb\tc\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `verbose with special characters in arguments and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Verbose,
                    tag = "LumberVerboseTest:verbose-with-special-characters-in-arguments-and-exception",
                    message = "a\nb\tca\nb\tc\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
