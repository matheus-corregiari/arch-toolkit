...
class LumberErrorTest {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    ...
                    tag = "LumberErrorTest:error-with-simple-message",
    ...
    fun `error with message and arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-message-and-arguments",
    ...
    fun `error with message and null arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-message-and-null-arguments",
    ...
    fun `error with message containing format specifiers but no arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-message-containing-format-specifiers-but-no-arguments",
    ...
    fun `error with more arguments than format specifiers`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-more-arguments-than-format-specifiers",
                    message = "this is a formatted text with 2 arguments",
                    error = null
                )
            )
    ...
    fun `error with very long message exceeding MAX LOG LENGTH`() {
        val tree = TestTree()
        Lumber.plant(tree)
        Lumber.error("a".repeat(6000))
        assertEquals(listOf(tree), Lumber.forest())
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-very-long-message-exceeding-MAX-LOG-LENGTH #0",
                    message = "a".repeat(4000),
                    error = null
                ),
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-very-long-message-exceeding-MAX-LOG-LENGTH #1",
    ...
    fun `error with message exactly MAX LOG LENGTH`() {
        val tree = TestTree()
        Lumber.plant(tree)
        Lumber.error("a".repeat(4000))
        assertEquals(listOf(tree), Lumber.forest())
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-message-exactly-MAX-LOG-LENGTH",
                    message = "a".repeat(4000),
                    error = null
                )
            )
    ...
    fun `error with special characters in message`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-special-characters-in-message",
                    message = "a\nb\tc",
                    error = null
                )
            )
    ...
    fun `error with special characters in arguments`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-special-characters-in-arguments",
                    message = "a\nb\tca\nb\tc",
                    error = null
                )
            )
    ...
    fun `error with explicit tag and long message`() {
        val tree = TestTree()
        Lumber.plant(tree)
        Lumber.tag("MyTag").error("a".repeat(6000))
        assertEquals(listOf(tree), Lumber.forest())
        tree.assertAll(
            listOf(
                TestTree.Data(
    ...
    fun `error with message and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-message-and-exception",
    ...
    fun `error with message arguments and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-message-arguments-and-exception",
                    message = "this is a formatted text with 2 arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `error with empty message and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-empty-message-and-exception",
    ...
    fun `error with message and null arguments plus exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-message-and-null-arguments-plus-exception",
                    message = "this is a null text with null arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `error with format specifiers but no arguments and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-format-specifiers-but-no-arguments-and-exception",
                    message = "this is a %s text with %d arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `error with more arguments than specifiers and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-more-arguments-than-specifiers-and-exception",
                    message = "this is a formatted text with 2 arguments\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `error when isLoggable is false with exception`() {
        ...
        Lumber.error(IllegalStateException("nope"), "normal text without arguments")
    ...
    fun `error when quiet is true with exception`() {
        ...
        Lumber.error(IllegalStateException("quiet"), "normal text without arguments")
    ...
    fun `error with special characters and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-special-characters-and-exception",
                    message = "a\nb\tc\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
    ...
    fun `error with special characters in arguments and exception`() {
        ...
        tree.assertAll(
            listOf(
                TestTree.Data(
                    level = Lumber.Level.Error,
                    tag = "LumberErrorTest:error-with-special-characters-in-arguments-and-exception",
                    message = "a\nb\tca\nb\tc\n\n${error.stackTraceToString()}",
                    error = error
                )
            )
